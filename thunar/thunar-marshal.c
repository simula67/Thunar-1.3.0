...
/* FLAGS:OBJECT,OBJECT (thunar-marshal.list:3) */
void
...
/* FLAGS:STRING,FLAGS (thunar-marshal.list:4) */
void
...
/* VOID:BOXED,OBJECT (thunar-marshal.list:5) */
void
_thunar_marshal_VOID__BOXED_OBJECT (GClosure     *closure,
                                    GValue       *return_value G_GNUC_UNUSED,
                                    guint         n_param_values,
                                    const GValue *param_values,
                                    gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:BOXED,POINTER (thunar-marshal.list:6) */
void
